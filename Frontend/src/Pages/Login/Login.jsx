    ...
    <div className="main-container">
      <div className="login-card">
        ...
        <div className="left-panel1">
          {/* Logo */}
          <div className="logo">
            <img src={gal_logo1} alt="Logo" className="logo-image" />
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group1">
              <div className="input-container">
                ...
                >
                  <svg id="eyeIcon" className="icon" viewBox="0 0 24 24">
                    <path
                      d={
                        passwordVisible
        ...
        <div className="right-panel1">
          {/* You can move this content to a separate component if needed */}
          {/* Keep your SVG illustrations and decorations here */}
        </div>
      </div>
