    ...
    <>
      ...
      <div className="header-container">
        <div className="header-container-heading">
          <h1 className="tasks-heading">Subject of the Ticket</h1>
        </div>
        <div className="header-container-buttons">
          <button className="send-email-button">Send Email</button>
          <button className="edit-button" onClick={() => setIsReadOnly(true)}>
            Edit
          </button>
        ...
        <div className="overview-form">
          <form>
            <div className="form-group createdon">
              <label htmlFor="createdon">Subject</label>
              <input
                type="text"
                placeholder="Subject"
                id="createdon"
            ...
            <div className="form-group duedate">
              <label htmlFor="duedate">Agent</label>
              <input
                type="text"
                placeholder="Agent"
                id="duedate"
            ...
            <div className="form-group subject">
              <label htmlFor="subject">Channel</label>
              <input
                type="text"
                placeholder="Channel"
                id="subject"
        ...
        <div className="task-information-form">
          <form>
            <div className="form-group taskowner">
              <label htmlFor="taskowner">Case Owner</label>
              <input
                type="text"
            ...
            <div className="form-group oppname">
              <label htmlFor="oppname">Case Subject</label>
              <input
                type="text"
            ...
            <div className="form-group subject">
              <label htmlFor="subject">Case Name</label>
              <input
                type="text"
            ...
            <div className="form-group stage">
              <label htmlFor="stage">Channel</label>
              {isReadOnly ? (
                <input
                  type="text"
                  placeholder="Channel"
            ...
            <div className="form-group primarycontact">
              <label htmlFor="primarycontact">Email</label>
              <input
                type="text"
                placeholder="Email"
                id="primarycontact"
            ...
            <div className="form-group accountname">
              <label htmlFor="accountname">Priority</label>
              <input
                type="text"
            ...
            <div className="form-group leadsource">
              <label htmlFor="leadsource">Phone</label>
              {isReadOnly ? (
                <input
                  type="text"
                  placeholder="Phone"
